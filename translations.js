const translations = {
    en: {
        ...
        drawingColorLabel: "Color:", 
        drawingBrushSizeLabel: "Brush Size:", 
        drawingClearCanvas: "Clear Canvas", 
        ...
        coloringPageChoose: "Choose an image to color:", 
        coloringPageAnimal: "Animal", 
        coloringPageMandala: "Mandala", 
        coloringPageNature: "Nature Scene", 
        coloringPageDinosaurs: "Dinosaurs",
        coloringPageSchool: "School",
        coloringPageFruit: "Fruit",
        coloringPageSweets: "Sweets & Treats",
        coloringPagePets: "Pets",
        coloringPageOcean: "Ocean Animals",
        coloringPageFastFood: "Fast Food",
        coloringPageSpaceCat: "Space Cat",
        coloringPageCatRainbow: "Cat & Rainbow",
        coloringPageFlowers: "Flowers",
        coloringPageCactus: "Cactus",
        coloringPageLoading: "Loading", 
        ...
        updateAffirmationButton: "Update Affirmation",
        editButtonText: "Edit",
        ...
        affirmationSavedSuccess: "Affirmation saved!", 
        affirmationUpdatedSuccess: "Affirmation updated!",
        affirmationDeletedSuccess: "Affirmation deleted.",
        confirmDeleteAffirmation: "Are you sure you want to delete this affirmation?",
        ...
        gratitudeJournalInstruction: "Take a few moments to write down things you are grateful for today, or respond to the prompt above.",
        gratitudeJournalPlaceholder: "Type here...",
        gratitudeJournalEmptyAlert: "Please write something you are grateful for.",
        gratitudeJournalSavedSuccess: "Gratitude entry saved!", 
        ...
        mindfulDrawingPrompt: "Focus on the sensation of drawing, the lines, and the colors. Let your creativity flow without judgment.",
        ...
        journalPromptTitle: "Need inspiration? Try this prompt:",
        ...
        modalContent: { 
            ...
            emotionCheckIn: {
                ...
                introduction: "Take a moment to notice and name how you're feeling right now, without judgment. You can use the prompt above for reflection.",
                ...
                checkInSavedSuccess: "Your emotional check-in has been saved.", 
            ...
            mindfulColoring: { 
                ...
                prompt: "Select a coloring page and begin coloring. Pay attention to the colors, the movement of your hand, and the texture of the page.",
                coloringPagePlaceholder: "(Imagine a beautiful coloring page here.)"
            },
    ...
    ja: {
        ...
        drawingColorLabel: "色：",
        drawingBrushSizeLabel: "ブラシサイズ：",
        drawingClearCanvas: "キャンバスを消去",
        ...
        coloringPageChoose: "色を塗る画像を選んでください：", 
        coloringPageAnimal: "動物", 
        coloringPageMandala: "曼荼羅", 
        coloringPageNature: "自然の風景", 
        coloringPageDinosaurs: "恐竜",
        coloringPageSchool: "学校",
        coloringPageFruit: "果物",
        coloringPageSweets: "お菓子",
        coloringPagePets: "ペット",
        coloringPageOcean: "海の生き物",
        coloringPageFastFood: "ファストフード",
        coloringPageSpaceCat: "宇宙猫",
        coloringPageCatRainbow: "猫と虹",
        coloringPageFlowers: "花",
        coloringPageCactus: "サボテン",
        coloringPageLoading: "読み込み中", 
        resetColorsButton: "色をリセット", 
        colorsReset: "色をリセットしました。",
        ...
        updateAffirmationButton: "アファメーションを更新",
        editButtonText: "編集",
        deleteButtonText: "削除",
        mySavedAffirmationsTitle: "保存したアファメーション：",
        affirmationEmptyAlert: "アファメーションを記入してください。",
        affirmationExistsAlert: "このアファメーションは既に保存されています。",
        affirmationSavedSuccess: "アファメーションが保存されました！",
        affirmationUpdatedSuccess: "アファメーションが更新されました！",
        affirmationDeletedSuccess: "アファメーションが削除されました。",
        confirmDeleteAffirmation: "このアファメーションを本当に削除しますか？",
        ...
        gratitudeJournalInstruction: "今日感謝していることをいくつか書き留めるか、上記のプロンプトに答えてみましょう。",
        gratitudeJournalPlaceholder: "ここに記入してください…",
        gratitudeJournalEmptyAlert: "感謝していることを何か書いてください。",
        gratitudeJournalSavedSuccess: "感謝のエントリーが保存されました！",
        pastGratitudeEntriesTitle: "過去の感謝のエントリー:",
        noGratitudeEntriesYet: "まだ感謝のエントリーを保存していません。",
        saveButtonText: "保存する",
        mindfulDrawingPrompt: "描画の感覚、線、色に集中してください。判断せずに創造性を発揮しましょう。",
        ...
        journalPromptTitle: "ひらめきが必要ですか？このプロンプトをお試しください：",
        newPromptButtonText: "新しいプロンプト",
        modalContent: { // All modal content details restored
            breathing: {
                title: "呼吸に集中する",
            ...
            emotionCheckIn: { 
                title: "感情チェックイン", 
                introduction: "判断せずに、今どのように感じているかに気づき、名前を付けるために少し時間を取ってください。上記のプロンプトを内省に使うことができます。",
                ...
                checkInSavedSuccess: "感情チェックインが保存されました。", 
            ...
            mindfulColoring: { 
                ...
                coloringPagePlaceholder: "（ここに美しい塗り絵ページを想像してください。）"
            },
            positiveAffirmations: {
